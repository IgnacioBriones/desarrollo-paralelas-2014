...
if (isset($_FILES['archivo']) && !empty($_FILES['archivo']['name']) && !empty($_POST['tipo_busqueda']) && !empty($_POST['tipo_ejecucion']))
	{
		...
		$consulta_secuencial_explicita = "python /mpi/SerialVersion.py ". "/mpi/desarrollo-paralelas-2014/web/subidas/".$nombre ." ".$_POST['frases'];
		//echo $consulta_secuencial;
		$consulta_secuencial_implicita = "python /mpi/SerialVersion.py ". "/mpi/desarrollo-paralelas-2014/web/subidas/".$nombre ." ".$_POST[''];
		//echo $consulta_secuencial;
